...
class RightZone extends React.Component{
	...
	render(){
		...
		return(
			<div className="RightZoneWrap ">
				<div className='RightZone clearfix'>
					 <div>
				...
				<div className="login_bot">
                      ...
                      <div className="login_ios">
                      	<a target="_blank" className="S_txt2" href="https://itunes.apple.com/cn/app/id350962117?mt=8" suda-data="key=nologin_home&amp;value=nologin_card_profile:iphone">
                          <span className="icon_box"></span>
                          <span className="icon_txt S_txt2">iPhone<br/>客户端下载</span>
                         </a>
                      </div>
                      <div className="login_andrio">
                      	<a target="_blank" className="S_txt2" href="http://c.weibo.cn/client/guide/download" suda-data="key=nologin_home&amp;value=nologin_card_profile:android">
                          <span className="icon_box"></span>
                          <span className="icon_txt S_txt2">Android<br/>客户端下载</span>
                         </a>
                      </div>
                 
                </div>
                {/* 图片专区*/}
                <div className="f_r mr10 pic_weibo">
                	<img src="http://ww4.sinaimg.cn/large/005M94J9jw1f33a105uixj306e02sjs7.jpg "/>
                </div>
			</div>
		)
